...
export const popularByTab: Record<HomeTabKey, PopularHotel[]> = {
  ...
  hourly: [
    { id: 'phr1', image: 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=600&q=80', name: '虹桥站亚朵', city: '上海', dates: '随时可订', price: 128, nights: 0, rating: 4.6 },
...
export const picksByTab: Record<HomeTabKey, EditorPick[]> = {
  hotel: [
    ...
    { id: 'ep5', image: 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=400&q=80', name: '丽江古城花间堂', price: 880, rating: 4.79 },
  ...
  hourly: [
    { id: 'eph1', image: 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=400&q=80', name: '亚朵·4h休息房', price: 128, rating: 4.6 },
